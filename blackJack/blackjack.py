'''
blackjack
5 deck shoe. Dealer draws while hand is below hard 17.
'''
...
def blackJack(money):
  ...
  #tests if player made a valid bet. Valid bets must be greate than 0 and less than what the player has. 
  ...
  while end == False:
    #pritn statements display the players hand and one card of the dealer.
